#--Tabla de frecuencia para datos no agrupados
 ...
 # - Frecuencia acumulada de hasta un dato: Luego de tener ordenados los datos,
 #saber hasta algún dato, cuántos frecuencias de datos hay antes de él.
 #Es decir, sabér cuántos datos hay en x parte de los datos.

 # - Frecuencia relativa de un dato: Dividir la frecuencia de un dato entre
 #la sumatoria de todas las frecuencias. (el tamaño de la muestra)
